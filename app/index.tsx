...
export default function App() {
  return (
    <View className="flex-1 items-center justify-center bg-white">
      ...
      <Link href="/(tabs)/subscriptions/sportify" className="mt-4 text-lg text-blue-500 p-4">
        Spotify Subscription 
      </Link>
      <Link href={{pathname: "/subscriptions/[id]", params: { id: "claude" }}} className="mt-4 text-lg text-blue-500 p-4">
